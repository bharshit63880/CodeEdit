...
function FilesView() {
    ...
    return (
        <div
            className="flex select-none flex-col gap-1 px-4 py-2 card shadow-2xl"
        ...
        >
            ...
            >
                <hr />
                <button
                    className="mt-2 flex w-full justify-start rounded-md p-2 btn-animated pulse"
                    onClick={handleOpenDirectory}
                    disabled={isLoading}
                >
                    <TbFileUpload className="mr-2 glow-float" size={24} />
                    {isLoading ? "Loading..." : "Open File/Folder"}
                </button>
                <button
                    className="flex w-full justify-start rounded-md p-2 btn-animated pulse"
                    onClick={downloadFilesAndFolders}
                >
                    <BiArchiveIn className="mr-2 glow-float" size={22} /> Download Code
                </button>
            </div>
        </div>
    )
